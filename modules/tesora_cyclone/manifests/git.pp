...
class tesora_cyclone::git (
  ...
  file { '/usr/local/bin/haproxy-statsd.py':
    ...
    group  => 'root',
    mode   => '0755',
    source => 'puppet:///modules/tesora_cyclone/git/haproxy-statsd.py',
  ...
  file { '/etc/default/haproxy-statsd':
    ...
    group   => 'root',
    mode    => '0755',
    source  => 'puppet:///modules/tesora_cyclone/git/haproxy-statsd.default',
  ...
  file { '/etc/systemd/system/haproxy-statsd.service':
    ...
    group   => 'root',
    mode    => '0644',
    source  => 'puppet:///modules/tesora_cyclone/git/haproxy-statsd.service',
