...
class tesora_cyclone::status (
  ...
  file { '/srv/static/status/common.js':
    ...
    content => template('tesora_cyclone/status/common.js.erb'),
    require => File['/srv/static/status'],
    replace => true,
  }
  ...
  file { '/srv/static/status/zuul/index.html':
    ...
    content => template('tesora_cyclone/zuul/status.html.erb'),
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/status.js':
    ensure  => present,
    content => template('tesora_cyclone/zuul/status.js.erb'),
    require => File['/srv/static/status/zuul'],
  }
