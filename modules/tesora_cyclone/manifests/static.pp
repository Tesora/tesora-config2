...
class tesora_cyclone::static (
  ...
  ::httpd::vhost { 'tarballs.openstack.org':
    ...
    priority   => '50',
    ssl        => true,
    template   => 'tesora_cyclone/static-http-and-https.vhost.erb',
  ...
  ::httpd::vhost { 'ci.openstack.org':
    ...
    template      => 'tesora_cyclone/ci.vhost.erb',
  }

  ###########################################################
  # Logs
  class { 'openstackci::logserver':
    jenkins_ssh_key         => $tesora_cyclone::jenkins_ssh_key,
  ...
  ::httpd::vhost { 'security.openstack.org':
    ...
    priority   => '50',
    ssl        => true,
    template   => 'tesora_cyclone/static-https-redirect.vhost.erb',
  ...
  ::httpd::vhost { 'governance.openstack.org':
    ...
    priority   => '50',
    ssl        => true,
    template   => 'tesora_cyclone/static-governance.vhost.erb',
  ...
  ::httpd::vhost { 'summit.openstack.org':
    ...
    priority      => '50',
    docroot       => 'MEANINGLESS_ARGUMENT',
    template      => 'tesora_cyclone/summit.vhost.erb',
  }
  ...
  ::httpd::vhost { 'devstack.org':
    ...
    template      => 'tesora_cyclone/devstack.vhost.erb',
  }
  ...
  ::httpd::vhost { 'releases.openstack.org':
    ...
    priority   => '50',
    ssl        => true,
    template   => 'tesora_cyclone/static-releases.vhost.erb',
