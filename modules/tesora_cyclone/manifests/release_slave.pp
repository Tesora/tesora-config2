...
class tesora_cyclone::release_slave (
  ...
  file { '/home/jenkins/.npmrc':
    ...
    group   => 'jenkins',
    mode    => '0600',
    content => template('tesora_cyclone/npmrc.erb'),
  ...
  file { '/home/jenkins/.puppetforge.yml':
    ...
    group   => 'jenkins',
    mode    => '0600',
    content => template('tesora_cyclone/puppetforge.yml.erb'),
    require => File['/home/jenkins'],
  }
  ...
  ::tesora_cyclone::reprepro { 'debian-openstack-reprepro':
    confdir       => '/etc/reprepro/debian-openstack',
    basedir       => '/afs/.openstack.org/mirror/debian-openstack',
    distributions => 'tesora_cyclone/reprepro/distributions.debian-openstack.erb',
